      ...
      <div id="cards" className="items-center max-lg:grid-cols-1 grid grid-cols-3 gap-5 justify-center max-lg:px-[2rem] px-[12rem]">
        {awardCards.map((item, index) => (
          <div key={index} className="p-[2%] relative w-full overflow-hidden">
            ...
            <a href={item.href} className="absolute top-[15px] right-[15px] hover:transition-all hover:ease-in-out hover:duration-1000 bg-[#FE5D00A4] hover:bg-[#FE5D00] text-white text-[14px] font-medium py-[8px] px-[10px] rounded-[3px] flex items-center">Submit Application <FiPlus className="ml-[5px] text-[12px]" /></a>
