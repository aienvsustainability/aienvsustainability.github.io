...
export const metadata: CustomMetadata = {
    title: "Contact",
    description:
        "Connect with CAIES Foundation to collaborate, inquire, or support our mission. Reach out through our contact page for partnerships, inquiries, or donations.",
    alternates: {
        canonical: "/contact",
        languages: {
            "en-US": "/",
    ...
    return (
        <main
            ...
            <h1 className="sr-only">
                Contact CAIES Foundation for collaboration,inquiries, and
                support.
            </h1>
            <Breadcrumb
                title="Contact"
