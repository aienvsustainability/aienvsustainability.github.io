...
import "./globals.css";
import { monoFont, barlowCondensed, glacialFont, poppins, satoshi } from "@/lib/fonts";
...
export default function RootLayout({
    ...
    return (
        <html lang="en" suppressHydrationWarning>
            <body
                className={`${poppins.variable} ${satoshi.variable} ${monoFont.variable} ${barlowCondensed.variable} ${glacialFont.variable} scroll-smooth outline-none bg-neutral-50 w-full overflow-x-hidden antialiased`} suppressHydrationWarning>
